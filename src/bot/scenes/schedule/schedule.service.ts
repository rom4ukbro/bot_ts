...
import { errorLoadText, loadSchedule, fullDays, weekDaysBtn, aboutText, choiceStudentText, choiceTeacherText, changeQueryText, nextWeekText, todayText, previousWeekText, manualDateBtnEntry, changeQueryBtnText, allWeekBtnText, aboutBtnText, enterDateText, errorDateText, floodText, mainMenu } from '../../text';
import { parse, toMessage, toWeekMessage } from '../../../parser/scheduleParse.js';
import { redisWriteData, redisGetData, redisDelData } from '../../../db/redis.js';
import { switchDay } from '../../helpers';
import { scheduleKeyboard } from './schedule.keyboard';
import { Markup } from "telegraf";
import { choiceKeyboard } from "../welcome/welcome.keyboard";
...
class ScheduleService {
  async enter(ctx: CustomContext) {
    try {
      ...
      ctx.session.weekDaysBtn[ctx.session.weekDaysBtn.findIndex((el: any) => el.text == ctx.session.day)] = {
        text: checkBtn,
