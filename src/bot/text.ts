...
const chooseWelcomeText = `Для початку, скажи мені хто ти${emoji.get(
  ":smirk_cat:"
)}:`;
...
const resetDefaultValueText =
  "Ти дійсно хочеш оновити значення по замовчуванню?";
...
const errorPassText =
  "Твій логін чи пароль написаний не правильно. \nСпробуй ще раз";
const errorLoginText = "Твій логін написаний не правильно. \nСпробуй ще раз";
const errorProgressText =
  "Сталася помилка, завантажити оцінки не вдалося. \nСпробуй пізніше";
...
const updateMail =
  'Сповістити всіх про оновлення бота?\nНапиши "ТАК" для підтвердження';
